...
const edgeBandHeightRoutes = require("./routes/edgeBandHeight");
const edgeBandThicknessRoutes = require("./routes/edgeBandThickness");
const edgeBandLogRoutes = require("./routes/edgeBandLog");
const tlfSyncAuditRoutes = require("./routes/tlfSyncAudit");
const tlfInfeedLogRoutes = require("./routes/tlfInfeedLog");
const tlfManualRemovalRoutes = require("./routes/tlfManualRemoval");
...
app.use("/edgeBandHeight", edgeBandHeightRoutes);
app.use("/edgeBandThickness", edgeBandThicknessRoutes);
app.use("/edgeBandLog", edgeBandLogRoutes);
app.use("/tlfSyncAudit", tlfSyncAuditRoutes);
app.use("/tlfInfeedLog", tlfInfeedLogRoutes);
app.use("/tlfManualRemoval", tlfManualRemovalRoutes);
